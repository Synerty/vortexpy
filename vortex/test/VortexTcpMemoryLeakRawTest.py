...
class VortexTcpMemoryLeakRawTest(unittest.TestCase,
    ...
    def _processData_patch(self):
        VortexTcpMemoryLeakRawTest._patchedProcessData_dataReceivedLen += len(self._data)
    ...
    def test_1vortexSend50mb_oneway_msg1mb_client_drop_data(self):
        ...
        VortexPayloadProtocol._processData = VortexTcpMemoryLeakRawTest._processData_patch
        ...
        for _ in range(2):
            print("Sleeping 2 seconds, send %s vs received %s"
